...
| `source/content/` | All authored content: `resume/`, the single source of truth for the resume, the whole website, and the profile README, and `articles/`, the blog posts                              |

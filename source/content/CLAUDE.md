...
| Document                                             | Owns                                                                                                                                                                        |
| ---------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`articles/CLAUDE.md`](./articles/CLAUDE.md)         | How to write a post                                                                                                                                                         |
| [`CONTRIBUTING.md`](./CONTRIBUTING.md)               | **Read it before editing anything here**: the verified-facts rule, the no-reformatting rule, the edit-and-rebuild loop, the `consumers:` workflow, and how to add a file or a post |

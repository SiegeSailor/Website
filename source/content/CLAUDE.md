...
| [`CONTRIBUTING.md`](./CONTRIBUTING.md)       | The edit-and-rebuild loop, the `consumers:` and `archived:` workflow, and how to add a file or an article |
| [`README.md`](./README.md)                   | What lives here and how it reaches the 4 outputs                                                          |
| [`resume/CLAUDE.md`](./resume/CLAUDE.md)     | The file map, what is archived today, and the resume constraints                                          |

...
The renderer is `../../website/components/Markdown.tsx`; check it and `../../website/helpers/plugin.ts` for what is supported.
...
- `:::<type>` callouts — the types are in `../../website/components/Callout.tsx`

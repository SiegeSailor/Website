...
//
// This is the one document that cannot read settings/content.ts: it is a client
// component (it takes `reset`), and that module is server-only. The last-resort
// error screen therefore carries its own literal title

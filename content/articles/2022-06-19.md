---
title: TypeScript Patterns and Configurations for Everyday Development
category: Programming
status: Ready
technologies: ["TypeScript"]
---

TypeScript offers a pretty neat type extension for JavaScript. However, setting up the configuration for a project is always a pain in the ass, and there are syntaxes that aren't supported for type hints. I collected some combinations that I often use for TypeScript projects, yet, not documented in the official site, sharing here to avoid stepping into the same pitfalls and get the projects running more smoothly. I believe many workarounds here will be patched by Type Guards or Utility Types in the future, but what I have here are the most easy-to-use solutions I have so far.
...
```typescript {3-4} title="./import.ts"
...
:::fact
[GitHub TypeScript Issue#5296 Support Spread Operator for Arrays and Tuples in Function Calls](https://github.com/microsoft/TypeScript/issues/5296) is about supporting spread operator for arrays and tuples in function calls and should have been available since TypeScript 2.4.2. However, its been confirmed that 5.5.2 and 3.8.3 still persist this defect.
:::

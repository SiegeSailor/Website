---
title: Versioning and Branch Management for LTS Projects in Git
category: DevOps
status: Published
technologies: ["Git", "GitLab"]
---

While building a GitLab template project for external developers, I did some research about software versioning and distribution. Unsurprisingly, there isn’t a universal standard. Most organizations develop their own conventions and timelines, mostly by the nature of their products or their ecosystem. At the time, I was juggling support for multiple products, so I set out to design a more general and practical workflow for managing projects with GitLab.
...
![GitLab-Project-Settings-Repository-Push-Rules](/image/GitLab-Project-Settings-Repository-Push-Rules.png)
...
![GitLab-Project-Settings-Repository-Protected-Branches](/image/GitLab-Project-Settings-Repository-Protected-Branches.png)
